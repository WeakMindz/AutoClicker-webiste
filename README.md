...
A customizable auto clicker with adjustable speed, click modes, and rebindable hotkeys — built with `customtkinter` and `pynput`.
...
- GitHub: [WeakMindz](https://github.com/WeakMindz)
- YouTube: [@WeakMindz](https://www.youtube.com/@WeakMindz)
